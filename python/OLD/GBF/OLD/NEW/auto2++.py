...
class doit:
    ...
    def four_one(self):
        ...
        while True:
            k = k + 1
            try:
                (x3_1, y3_1) = pyautogui.locateCenterOnScreen("3_1.png", confidence=0.9)
            except:
                pass
            else:
    ...
    def nine(self):
        ...
        while True:
            k = k + 1
            try:
                (x1_1, y1_1) = pyautogui.locateCenterOnScreen("1_1.png", confidence=0.8)
                sleep(0.1)
            except:
                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            pyautogui.click(x=xifno, y=yifno, clicks=1, button="left")
                            k = 0
                            sleep(0.1)
                            break
                    else:
