    ...
    def realdo(self):
        ...
        while True:
            ...
            while j < 1:
                ...
                k = k + 1
                try:
                    (x5, y5) = pyautogui.locateCenterOnScreen("5.png", confidence=0.9)
                except:
                    pass
                else:
            ...
            while j < 1:
                ...
                k = k + 1
                try:
                    (x6, y6) = pyautogui.locateCenterOnScreen("6.png", confidence=0.9)
                except:
                    pass
                else:
            ...
            while j < 1:
                ...
                k = k + 1
                try:
                    (x8, y8) = pyautogui.locateCenterOnScreen("8.png", confidence=0.9)
                except:
                    pass
                else:
            ...
            while j < 1:
                ...
                k = k + 1
                try:
                    (x9, y9) = pyautogui.locateCenterOnScreen("9.png", confidence=0.9)
                except:
                    pass
                else:
            ...
            while j < 1:
                ...
                try:
                    (x12, y12) = pyautogui.locateCenterOnScreen(
                        "12.png", confidence=0.95
                    )
                except:
                    try:
                        (x11_2, y11_2) = pyautogui.locateCenterOnScreen(
                            "11.png", confidence=0.95
                        )
                    except:
                        pass
                    else:
